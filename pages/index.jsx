                    ...
                    <div className="container px-5 py-24 mx-auto">
                        ...
                        <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
                            ...
                            <div className="w-full lg:w-1/2 px-4 py-2">
                                <details className="mb-4">
                                    <summary className="font-semibold  bg-gray-200 rounded-md py-2 px-4">
                                        Why influencer marketing more effective?
                                    </summary>

                                    <span className="px-4 py-2">
                                    Influencer marketing is more effective than traditional advertising that stars celebrities as potential customers and celebrities, wherein they do not share any intimate and trustful relation among them.
                                    </span>
                                </details>
                                {/* <details className="mb-4">
                                    <summary className="font-semibold  bg-gray-200 rounded-md py-2 px-4">
