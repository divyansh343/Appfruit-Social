...
const Features = () => {
    return (
        <>
            ...
            <section className="px-4 py-20 bg-[#6102d3]">
                <div className="container max-w-6xl mx-auto">
                    <h2 className="text-4xl font-semibold text-[#ffffff]  tracking-tight text-center">Influencer Marketing Services</h2>
                    <div className="grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0">

                        <div className="relative rounded-2xl shadow-xl flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden bg-gray-100">
                            ...
                            <h4 className="text-2xl font-bold text-[#6102d3]">Youtube Influencers</h4>
                            <p className="text-base text-center  text-gray-700">Collaborate with top, high-reach YouTube channels to feature your brand, deliver brand messaging, and engage targeted audiences. testing, targeting, and analytics to measure the effectiveness of campaigns are all included in this one-stop solution</p>
                        </div>

                        <div className="flex rounded-2xl shadow-xl flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 ">
                            <div className="p-3 text-white bg-blue-500 rounded">
                        ...
                        <div className="flex rounded-2xl shadow-xl flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100">
                            ...
                            <h4 className="text-2xl text-center font-bold text-[#6102d3]">Social Media Marketing</h4>
                            <p className="text-base text-center  text-gray-700">We can help you reach the widest audience possible, build an engaged customer base, and grow your business. We can help you create a social media marketing strategy tailored to your needs, and then execute it with our expertise.</p>
                        </div>
