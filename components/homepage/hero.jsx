...
<section className="bg-purple-200 dark:bg-gray-900 pt-7">
                    <div className="pl-10 grid max-w-screen-xl px-4 pt-32 pb-4 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 ">
                        <div className="mr-auto place-self-center lg:col-span-7">
                            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl dark:text-white">Your marketing companion. </h1>
                            <p className="max-w-2xl mb-6 font-light text-4xl text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Directing businesses towards success</p>
                        ...
                        <div className="hidden overflow-hidden lg:mt-0 lg:col-span-5 lg:flex">
                            <Image src="https://images.unsplash.com/photo-1658259757270-ded0f2fd4635?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwyM3x8fGVufDB8fHx8&auto=format&fit=crop&w=400&q=60" alt="mockup" width={300} height={400} />
                        </div>
                    </div>
                </section>
